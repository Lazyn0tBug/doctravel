...
export default {
  ...
  computed: {
    ...
    headphones() {
      return this.productInfo.filter((product) => product.category === 'headphones')
    },
    earphones() {
      return this.productInfo.filter((product) => product.category === 'earphones')
    },
    speakers() {
      return this.productInfo.filter((product) => product.category === 'speakers')
    },
    currentProducts() {
