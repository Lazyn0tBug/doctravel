      ...
      <div class="checkout__form__input">
        ...
        <section>
          <div class="checkout__form__input__item">
            <div class="input-texts">
              <label for="name" :class="emptyFields.includes('name') ? 'red-label' : ''"
                >Name</label
              >
              <p class="empty-message" v-if="emptyFields.includes('name')">Field can't be empty</p>
            </div>
            <input
              type="text"
              name="name"
          ...
          <div class="checkout__form__input__item no-margin">
            <div class="input-texts">
              <label for="email" :class="emptyFields.includes('email') ? 'red-label' : ''"
                >Email address</label
              >
              <p class="empty-message" v-if="emptyFields.includes('email')">Field can't be empty</p>
              <p class="empty-message" v-if="invalidEmail">Invalid email address</p>
            </div>
          ...
          <div class="checkout__form__input__item">
            <div class="input-texts">
              <label for="phone" :class="emptyFields.includes('phone') ? 'red-label' : ''"
                >Phone number</label
              >
              <p class="empty-message" v-if="emptyFields.includes('phone')">Field can't be empty</p>
            </div>
        ...
        <section>
          <div class="checkout__form__input__item no-margin full-span">
            <div class="input-texts" id="address-texts">
              <label for="address" :class="emptyFields.includes('address') ? 'red-label' : ''"
                >Your address</label
              >
          ...
          <div class="checkout__form__input__item">
            <div class="input-texts">
              <label for="zip" :class="emptyFields.includes('zip') ? 'red-label' : ''"
                >ZIP code</label
              >
              <p class="empty-message" v-if="emptyFields.includes('zip')">Field can't be empty</p>
            </div>
          ...
          <div class="checkout__form__input__item no-margin">
            <div class="input-texts">
              <label for="city" :class="emptyFields.includes('city') ? 'red-label' : ''"
                >City</label
              >
              <p class="empty-message" v-if="emptyFields.includes('city')">Field can't be empty</p>
            </div>
          ...
          <div class="checkout__form__input__item">
            <div class="input-texts">
              <label for="country" :class="emptyFields.includes('country') ? 'red-label' : ''"
                >Country</label
              >
        ...
        <section>
          <div class="checkout__form__input__item payment-method">
            ...
            <div class="methods">
              <div
                :class="['radio-container', picked === 'e-money' ? 'orange-border' : '']"
              ...
              >
                <input type="radio" id="cash" name="payment-method" value="cash" v-model="picked" />
          ...
          <div class="checkout__form__input__item" v-if="picked === 'e-money'">
            <div class="input-texts">
              ...
              <p class="empty-message" v-if="emptyFields.includes('emoney-number')">
                Field can't be empty
              </p>
            </div>
            ...
            <input
              ...
              id="emoney-number"
              ref="emoneyNumber"
              :class="emptyFields.includes('emoney-number') ? 'empty-border' : ''"
              @click="wipeError('emoney-number')"
              @change="wipeError('emoney-number')"
            />
          </div>
          <div class="checkout__form__input__item no-margin" v-if="picked === 'e-money'">
            <div class="input-texts">
              <label for="emoney-pin" class="no-capitalize">e-Money PIN</label>
              <p class="empty-message" v-if="emptyFields.includes('emoney-pin')">
                Field can't be empty
              </p>
            </div>
...
export default {
  ...
  computed: {
    total() {
      let totalValue = 0
      this.cart.forEach((product) => (totalValue += product.price * product.addedQuantity))
      return totalValue
    },
    vat() {
